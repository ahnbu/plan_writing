...
1.  **Framework Selection**: 주제의 성격에 맞는 분석 프레임워크를 하나 선정하십시오.
    - 시장 진입/분석: **3C** (Company, Customer, Competitor) 또는 **PESTEL**
    - 신사업 기획: **Lean Canvas** 요소
    - 내부 역량 분석: **7S Model** 또는 **SWOT**
2.  **Question Design**: 선정된 프레임워크의 각 요소를 3~4개의 Deep-dive 질문으로 변환하십시오.
    - Bad: "경쟁사는 누구인가?"
    - Good: "국내 시장 점유율 상위 3개사의 2024년 매출 성장률과 주력 상품 라인업은 무엇인가?"
